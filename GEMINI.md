...
```bash
uv add requests beautifulsoup4 pandas numpy matplotlib seaborn scikit-learn koreanize-matplotlib loguru wordcloud plotly
```
...
```
* seaborn의 스타일 설정은 사용하지 말 것, matplotlib를 사용하세요.
### 폰트 지정
