...
데이터와 분석 내용은 다음 파일을 참고할 것 => Starbucks_WebScraping\data\starbucks_AIdata.csv
starbucks_stores 해당 경로의 분석 결과도 참고할 것 => Starbucks_WebScraping\starbucks_eda_report.md
